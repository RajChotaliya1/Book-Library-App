...
const CollectionView = () => {
  ...
  return (
    <motion.div
      className="px-5 sm:px-6 py-8"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6, ease: "easeOut" }}
    >
      <h1 className="font-medium text-2xl sm:text-3xl mb-6 text-center">
        Book Collections
      </h1>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
        ...
        <button
          ...
          className="bg-black text-white p-2 hover:opacity-90 cursor-pointer w-full sm:w-auto active:scale-98"
        >
          Add Collection
        </button>
      </div>
      ...
      <div className="mt-15">
        <h2 className="text-xl sm:text-2xl text-center md:text-left font-medium text-black mb-3 sm:mb-8">
          ...
          {collections.length === 0 ? (
            ...
            collections.map((col) => (
              <div
                ...
                className={`relative mx-2 px-6 py-4 rounded-md shadow-sm transition-all duration-300 w-50 cursor-pointer backdrop-blur-md border mb-4 mt-4 sm:mt-0 ${
