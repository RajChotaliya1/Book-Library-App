...
const BooksData = ({
  ...
  return (
    <>
      <motion.div
        className="flex justify-between items-center px-4 md:px-5 py-5 sm:py-8"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        {!title && (
          <Link to="/browsebooks">
            <p className="text-black font-normal text-xs sm:text-base underline underline-offset-2">
              View more
            </p>
          </Link>
        )}
